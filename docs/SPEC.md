...
// performs the file read on EVERY call and backs the /reload-env command.
...
**Runtime reload (D-057):** the `/reload-env` command calls `reloadEnvFile()` and
